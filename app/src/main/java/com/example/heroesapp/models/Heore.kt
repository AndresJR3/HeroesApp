...
data class Heroe(
    ...
    companion object {
        val heroes = mutableListOf<Heroe>(
            ...
            Heroe(2, "Iron Man (Tony Stark)", "Un genio multimillonario que, tras ser secuestrado, construye una armadura avanzada para escapar. A partir de ahí, usa su tecnología para proteger el mundo como Iron Man, líder de los Vengadores.", "",1),
            ...
            Heroe(14, "Flash (Barry Allen)", "Un científico que adquiere velocidad sobrehumana tras un accidente con rayos. Es conocido como el hombre más rápido del mundo.", "https://cdn.pixabay.com/photo/2021/04/23/11/07/the-flash-6199867_1280.png", 2),
            Heroe(15, "Aquaman (Arthur Curry)", "Rey de Atlantis, con la capacidad de respirar bajo el agua, comunicarse con la vida marina y una fuerza sobrehumana.", "https://upload.wikimedia.org/wikipedia/en/9/9d/Aquaman_Movie_Poster.jpg", 2),
            Heroe(16, "Green Lantern (Hal Jordan)", "Un piloto de pruebas que recibe un anillo de poder de un extraterrestre moribundo, otorgándole la habilidad de crear construcciones de energía pura.", "https://upload.wikimedia.org/wikipedia/en/3/35/Green_Lantern_%28Hal_Jordan%29.png", 2),
            Heroe(17, "Cyborg (Victor Stone)", "Un ex-atleta que tras un accidente queda fusionado con tecnología avanzada, convirtiéndose en un héroe cibernético con una increíble variedad de poderes tecnológicos.", "https://upload.wikimedia.org/wikipedia/en/b/ba/Cyborg_%28Victor_Stone%29.jpg", 2),
            Heroe(18, "Shazam (Billy Batson)", "Un niño que se convierte en un superhéroe adulto al gritar 'Shazam'. Tiene la sabiduría de Salomón, la fuerza de Hércules y otros poderes místicos.", "https://upload.wikimedia.org/wikipedia/en/a/a8/Shazam_%28DC_Rebirth_version%29.jpg", 2),
            Heroe(19, "Green Arrow (Oliver Queen)", "Un arquero experto y millonario que lucha contra el crimen usando sus habilidades en tiro con arco y tecnología avanzada.", "https://upload.wikimedia.org/wikipedia/en/4/4a/Green_Arrow_%28DC_Rebirth_version%29.png", 2),
            Heroe(20, "Martian Manhunter (J'onn J'onzz)", "Un extraterrestre con habilidades como cambio de forma, telepatía y fuerza sobrehumana, miembro de la Liga de la Justicia.", "https://upload.wikimedia.org/wikipedia/en/f/f0/Martian_Manhunter_Rebirth.jpg", 2)
